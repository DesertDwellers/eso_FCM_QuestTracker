...
function CreateSettings()
	...
	optionsData[#optionsData + 1] = {
		...
		controls = {
			...
			{--Show/Hide Zone in Craft Quests
				type = "checkbox",
				name = FCMQT.mylanguage.lang_craft_show_zone,
				tooltip = FCMQT.mylanguage.lang_craft_show_zone_tip,
				getFunc = FCMQT.GetQuestsCategoryCraftOption,
				setFunc = FCMQT.SetQuestsCategoryCraftOption,
				disabled = function() return not FCMQT.SavedVars.QuestsHybridOption end,
			},
	...
	optionsData[#optionsData + 1] = {
		...
		controls = {
			...
			{--Hide Object/Hints EXCEPT when focused --
				...
				getFunc = FCMQT.GetHideObjHintsNotFocused,
				setFunc = FCMQT.SetHideObjHintsNotFocused,
			},
			{-- Hide completed--
				type = "checkbox",
